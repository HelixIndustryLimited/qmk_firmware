...
#define VENDOR_ID 0x484C
#define PRODUCT_ID 0x4455
...
#define MATRIX_COL_PINS \
    { F0, C7, D2, D3, D4, D5, D6, D7, E0, E1, C0, C1, C2, C3, C4, C5, C6 }
/* COL2ROW, ROW2COL*/
...
#define RGB_MATRIX_MAXIMUM_BRIGHTNESS 150 // limits maximum brightness of LEDs to 150 out of 255. If not defined maximum brightness is set to 255
#define RGB_MATRIX_STARTUP_MODE RGB_MATRIX_ALPHAS_MODS // Sets the default mode, if none has been set
#define RGB_MATRIX_STARTUP_HUE 105 // Sets the default hue value, if none has been set
#define RGB_MATRIX_STARTUP_SAT 250 // Sets the default saturation value, if none has been set
...
#define ENABLE_RGB_MATRIX_RAINDROPS	Enables
